...
if(isset($_POST['guardar']))
{
	...
	if($_SESSION['LegajoParaModificar']!="XXXXXX")
	{
		$miUsuario= new Persona();
...
{
	$UsuarioParaModificar= Persona::TraerUsuarioPorNombre($_POST['idLegajoParaModificar']);	
}
	...
	<div class="main"><div class="inner_copy"></div>
		<div class="left">
			<div class="content">
				...
				<!-- <input type="text" name="id" id="id" placeholder="Ingrese numero de id" value="<?php if(isset($_POST['idLegajoParaModificar'])){ echo $UsuarioParaModificar->_id;} ?>"/>
				</br> -->
